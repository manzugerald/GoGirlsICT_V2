...
const desktopNavBase =
  'relative inline-flex items-center gap-1 rounded-full px-3 py-1.5 text-sm font-semibold transition-all duration-200';
...
const utilityButton =
  'inline-flex items-center justify-center rounded-full p-2 text-white/90 hover:bg-white/12 hover:text-white transition-all duration-200';
  ...
  return (
    <>
          ...
          if (hasChildren) {
            return (
              <div key={item.label} className="relative group">
                ...
                <div className="invisible absolute left-0 top-full z-50 mt-3 w-[350px] translate-y-2 opacity-0 transition-all duration-200 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100">
                  <div className="overflow-hidden rounded-3xl border border-white/40 bg-white/95 shadow-2xl shadow-black/20 backdrop-blur-xl dark:border-white/10 dark:bg-gray-950/95">
                    ...
                    <div className="border-b border-gray-200/80 bg-gradient-to-br from-[#9f004d]/10 via-pink-50 to-white p-4 dark:border-gray-800 dark:from-[#9f004d]/25 dark:via-gray-950 dark:to-gray-900">
                      <div className="flex gap-3">
                        {Icon && (
                          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#9f004d]/10 text-[#9f004d] ring-1 ring-[#9f004d]/10 dark:bg-pink-500/15 dark:text-pink-300 dark:ring-pink-500/10">
                      ...
                      {item.children?.map((child) => {
                        ...
                        return (
                          <Link
                            key={child.href}
                            href={child.href}
                            className={`flex gap-3 rounded-2xl px-3 py-3 transition-all duration-200 ${
                              childActive
      ...
      >
        ...
        <div
          className={`absolute left-0 right-0 top-0 bg-white/95 shadow-2xl backdrop-blur-xl transition-transform duration-300 dark:bg-gray-950/95 ${
                        ...
                        <div className="mt-2 overflow-hidden rounded-2xl bg-gray-50 p-2 ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
                          ...
                          {item.children?.map((child) => {
                            ...
                            return (
                              ...
                              >
                                {ChildIcon && <ChildIcon className="mt-0.5 h-4 w-4 shrink-0" />}
