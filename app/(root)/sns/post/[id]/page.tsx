  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
      <div className="mx-auto w-[90%] py-14 sm:py-20">
        ...
        <article className="mx-auto mt-6 max-w-2xl overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
          ...
          <div className="p-6 sm:p-8">
            ...
            {post.message && (
              <p className="body mt-4 whitespace-pre-line text-gray-700 dark:text-gray-200">
                {post.message}
              </p>
            )}
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-2.5 caption font-semibold text-white shadow-sm transition-colors hover:bg-blue-700"
            >
              View on Facebook
