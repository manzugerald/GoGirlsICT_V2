...
function AdminSection({ paginatedData, page, rowsPerPage, handleEdit, handleView, handleDelete, messagesCountMap, responsesCountMap, currentUserRole, TableActions, onAddMessage }) {
    _s();
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminSection.useMemo[columns]": ()=>[
                {
                    id: 'number',
                    header: 'No.',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>(page - 1) * rowsPerPage + row.index + 1
                    }["AdminSection.useMemo[columns]"],
                    size: 50
                },
                {
                    ...
                    header: 'Username',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "whitespace-normal break-words max-w-xs",
                ...
                },
                {
                    ...
                    header: 'Name',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>`${row.original.firstName ?? ''} ${row.original.lastName ?? ''}`.trim() || '-'
                    }["AdminSection.useMemo[columns]"]
                },
                {
                    accessorKey: 'email',
                    header: 'Email',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>row.getValue('email') ?? '-'
                    }["AdminSection.useMemo[columns]"]
                },
                {
                    id: 'role',
                    header: 'Role',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>row.original.role ?? '-'
                    }["AdminSection.useMemo[columns]"]
                },
                {
                    accessorKey: 'createdAt',
                    header: 'Created At',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>row.getValue('createdAt') ? new Date(row.getValue('createdAt')).toLocaleDateString() : ''
                    }["AdminSection.useMemo[columns]"]
                },
                {
                    id: 'view',
                    header: 'View',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>handleView ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                type: "button",
                                size: "sm",
                                variant: "outline",
                                className: "transition-colors duration-150 hover:bg-blue-100 dark:hover:bg-blue-800 hover:text-blue-900 dark:hover:text-blue-100",
                                onClick: {
                                    "AdminSection.useMemo[columns]": ()=>handleView(row.original)
                                }["AdminSection.useMemo[columns]"],
                                children: "View"
                            }, void 0, false, {
                                fileName: "[project]/app/(admin)/admin/dashboard/components/sections/AdminSection.tsx",
                ...
                },
                {
                    ...
                    header: 'Edit',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>handleEdit ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                type: "button",
                                size: "sm",
                                variant: "outline",
                                className: "transition-colors duration-150 hover:bg-yellow-100 dark:hover:bg-yellow-800 hover:text-yellow-900 dark:hover:text-yellow-100",
                                onClick: {
                                    "AdminSection.useMemo[columns]": ()=>handleEdit(row.original)
                                }["AdminSection.useMemo[columns]"],
                                children: "Edit"
                            }, void 0, false, {
                                fileName: "[project]/app/(admin)/admin/dashboard/components/sections/AdminSection.tsx",
                ...
                },
                {
                    ...
                    header: 'Delete',
                    cell: {
                        "AdminSection.useMemo[columns]": ({ row })=>handleDelete ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                type: "button",
                                size: "sm",
                                variant: "destructive",
                                className: "transition-colors duration-150 hover:bg-red-600 dark:hover:bg-red-800 hover:text-white dark:hover:text-white",
                                onClick: {
                                    "AdminSection.useMemo[columns]": ()=>handleDelete(row.original.id)
                                }["AdminSection.useMemo[columns]"],
                                children: "Delete"
                            }, void 0, false, {
                                fileName: "[project]/app/(admin)/admin/dashboard/components/sections/AdminSection.tsx",
    ...
    }["AdminSection.useMemo[columns]"], // eslint-disable-next-line react-hooks/exhaustive-deps
    [
        page,
        rowsPerPage,
        handleEdit,
...
_s(AdminSection, "erkfbBpUuAY09jdvhSOqc0XsEHQ=");
_c = AdminSection;
var _c;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
            ...
            children: [
                ...
                mode === 'edit' && userId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CreateOrEditUserForm, "KDNM9NNHuw7CWipQ3QRiCWdwckc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
"[project]/app/(admin)/admin/dashboard/components/views/adminView.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AdminView() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AdminsSection, {
                paginatedData: users,
                page: 1,
                rowsPerPage: 100,
                handleEdit: (u)=>{
...
_s(AdminView, "KBDUWOr5aRtknada3KsIfhS5m9U=");
_c = AdminView;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$views$2f$adminView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(admin)/admin/dashboard/components/views/adminView.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
    ...
    function renderSection() {
        if (viewRecord) {
            switch(activeSection){
                ...
                case 'users':
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$views$2f$adminView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                        fileName: "[project]/app/(admin)/admin/dashboard/page.tsx",
                        lineNumber: 398,
                        columnNumber: 18
                    }, this);
...
//# sourceMappingURL=_335c8bdb._.js.map