...
async function GET(req, { params }) {
    try {
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequestResponse.findUnique({
            where: {
                id: params.id
            },
            select: {
        ...
        if (!data) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Not found'
        }, {
            status: 404
        });
...
"[project]/app/(admin)/admin/dashboard/createBeneficiaryRequestResponseForm.tsx [app-client] (ecmascript, next/dynamic entry)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/app/(admin)/admin/dashboard/createBeneficiaryRequestResponseForm.tsx [app-client] (ecmascript)"));
}}),
}]);

//# sourceMappingURL=_9c338fb5._.js.map