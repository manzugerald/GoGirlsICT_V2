...
;
;
function beneficiaryColumns({ onEdit, onDelete, onAddMessage, onAddRequest }) {
    return [
        {
            accessorKey: 'firstName',
            header: 'First Name',
        ...
        {
            accessorKey: 'beneficiaryStatus',
            header: 'Status',
            cell: ({ row })=>row.getValue('beneficiaryStatus') || '-'
        },
        {
            id: 'actions',
            header: 'Actions',
...
"[project]/app/(admin)/admin/dashboard/data-table/columns/beneficiaryMessages.tsx [app-client] (ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    const e = new Error("Cannot find module '@/app/(admin)/admin/dashboard/data-table/columns/beneficiaryRequests'");
...
function AdminDashboardPage() {
    ...
    const sectionFeatures = {
        ...
        beneficiaryRequests: {
            ...
            columns: beneficiaryRequestColumns,
            getColumns: ()=>[
                    {
                        id: 'number',
                        header: 'No.',
...
_s(AdminDashboardPage, "HOr+qpQLD1hFfsA/bOzG05rrfjU=", false, function() {
    return [
...
__turbopack_context__.k.register(_c6, "AdminDashboardPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_79484a6d._.js.map