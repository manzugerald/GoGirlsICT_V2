...
function CreateResponseForm({ messageId, editId, initialData, onSuccess, onCancel }) {
    ...
    const effectiveEditId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CreateResponseForm.useMemo[effectiveEditId]": ()=>editId ?? initialData?.id
    }["CreateResponseForm.useMemo[effectiveEditId]"], [
        editId,
        initialData?.id
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateResponseForm.useEffect": ()=>{
            ...
            if (isEditing && effectiveEditId) {
                setLoadingInitial(true);
                fetch(`/api/responses/${effectiveEditId}`).then({
                    "CreateResponseForm.useEffect": (res)=>{
                        if (!res.ok) throw new Error('Failed to fetch response');
                        return res.json();
                    }
                }["CreateResponseForm.useEffect"]).then({
                    "CreateResponseForm.useEffect": (data)=>{
                ...
                }["CreateResponseForm.useEffect"]).catch({
                    "CreateResponseForm.useEffect": ()=>{
                        alert('Error loading existing response data.');
                    }
                }["CreateResponseForm.useEffect"]).finally({
                    "CreateResponseForm.useEffect": ()=>setLoadingInitial(false)
                }["CreateResponseForm.useEffect"]);
            } else {
                setForm({
                    messageId: messageId ?? '',
...
_s(CreateResponseForm, "ygtXeV+P/+HaUdjA5D5EJMaXuwM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
function ResponseView({ data, onClose }) {
    ...
    const renderContent = ()=>{
        if (content === undefined || content === null) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            children: "-"
        }, void 0, false, {
...
__turbopack_context__.k.register(_c1, "ResponseView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_20ca9645._.js.map