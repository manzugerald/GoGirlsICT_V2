...
// columns still used directly on "Home Page" section
...
function AdminDashboardPage() {
    ...
    // cached data for Home Page section
    ...
    // Build section features registry from extracted module
    const sectionFeatures = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboardPage.useMemo[sectionFeatures]": ()=>createSectionFeatures({
                page,
                rowsPerPage,
                role,
                messagesCountMap,
    ...
    }["AdminDashboardPage.useMemo[sectionFeatures]"], [
        page,
        rowsPerPage,
        role,
        messagesCountMap,
    ...
    // when viewing Beneficiary Requests, pre-compute responses count
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboardPage.useEffect": ()=>{
    ...
    // when viewing Beneficiaries, compute counts of messages/requests per beneficiary
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboardPage.useEffect": ()=>{
    ...
    async function handleCardClick(section) {
        ...
        if (section === 'Home Page') {
            setData([]); // reset table data for home page; managed separately
            return;
        }
        if (feat?.apiRoute) {
            try {
    ...
    const getCreateFormComponent = ()=>{
        ...
        // generic create/edit form for other sections
        const createFormMap = {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: sections.map((section)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        className: `cursor-pointer px-4 py-3 flex items-center justify-center text-center rounded-sm whitespace-nowrap font-medium transition ${activeSection === section ? 'bg-[#9f004d] text-white shadow-2xl border-2 border-[#9f004d] scale-105' : 'text-gray-400 opacity-70 grayscale hover:opacity-100 hover:grayscale-0'}`,
                        style: {
                            width: 'auto',
                            minWidth: '3rem',
                            maxWidth: '100%'
...
_s(AdminDashboardPage, "9i6slH3hXjn+jB83W3PMTfbuHl4=", false, function() {
    return [
...
//# sourceMappingURL=_6149d87f._.js.map