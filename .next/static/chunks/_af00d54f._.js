...
currentUserId, onOpenEdit }) {
    ...
    function openLocalEdit(forPassword = false, forUsername = false) {
        // If the parent wants to handle opening edit instead, it may pass onOpenEdit.
        // But default behavior: render the edit form inside Settings modal.
        if (onOpenEdit) {
            // call parent if provided (backwards compatibility)
            onOpenEdit({
                id,
                forceChangePassword: forPassword,
                forceChangeUsername: forUsername
            });
        // If you prefer parent-handled flow, return here. Otherwise we also open local modal.
        // return;
        }
...
//# sourceMappingURL=_af00d54f._.js.map