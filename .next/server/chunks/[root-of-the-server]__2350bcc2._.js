...
"[project]/app/api/responses/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const canAdminManage = (role)=>role === 'super' || role === 'admin' || role === 'moderator';
...
async function GET() {
    try {
        ...
        const responses = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.findMany({
            where,
            orderBy: {
                createdAt: 'desc'
            },
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(responses);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const { messageId: rawMessageId, content } = body;
        ...
        const messageId = Number.isFinite(parsedMessageId) && !Number.isNaN(parsedMessageId) ? parsedMessageId : rawMessageId;
        ...
        const msg = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.findUnique({
            where: {
                id: messageId
            },
            select: {
        ...
        if (!msg) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        let responderType = 'user';
        let responderUserId = undefined;
        let responderBeneficiaryId = undefined;
        ...
        try {
            const created = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.create({
                data: {
                    messageId: messageId,
                    responderType,
            ...
            if (msgErr.includes('Unknown argument `responderRole`') || msgErr.includes('Unknown arg `responderRole`')) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2350bcc2._.js.map