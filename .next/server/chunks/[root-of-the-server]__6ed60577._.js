...
"[project]/.next-internal/server/app/api/beneficiaryMessages/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/beneficiaryMessages/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const CACHE_KEY = 'beneficiaryMessages:all';
const CACHE_TTL = 60; // 60 seconds
async function GET() {
    try {
        // Uncomment for redis caching
        // const cached = await redis.get(CACHE_KEY);
        // if (cached) return NextResponse.json(JSON.parse(cached));
        const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryMessage.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            include: {
        ...
        // Uncomment for redis caching
        // await redis.set(CACHE_KEY, JSON.stringify(messages), 'EX', CACHE_TTL);
...
async function POST(req) {
    try {
        ...
        const { beneficiaryId, title, beneficiaryMessageText, status } = body;
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryMessage.create({
            data: {
                beneficiaryId,
                title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6ed60577._.js.map