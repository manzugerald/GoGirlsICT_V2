...
"[project]/.next-internal/server/app/api/messages/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/messages/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function isMessageCategory(v) {
    return typeof v === 'string' && messageCategoryOptions.includes(v);
}
function getNames(session) {
...
async function getOwnBeneficiaryIdFromSession(session) {
    const role = asRole(session?.user?.role);
    if (role !== 'beneficiary') return null;
    const { firstName, lastName } = getNames(session);
    if (!firstName || !lastName) return null;
    const match = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findFirst({
        where: {
            firstName: {
                equals: firstName,
                mode: 'insensitive'
...
const canPublish = (role)=>role === 'super' || role === 'admin' || role === 'moderator';
const canDelete = (role)=>role === 'super' || role === 'admin';
function ownCacheKey(firstName, lastName) {
    return `${BENEFICIARIES_OWN_PREFIX}${encodeURIComponent(firstName)}|${encodeURIComponent(lastName)}`;
}
async function GET(_req, context) {
    try {
        ...
        const role = asRole(session?.user?.role);
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.findUnique({
            where: {
                id: Number(params.id) || params.id
            },
            include: {
                beneficiary: {
                    select: {
...
async function PATCH(req, context) {
    try {
        ...
        const role = asRole(session.user.role);
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.findUnique({
            where: {
                id: Number(params.id) || params.id
            },
            select: {
        ...
        let { title, affiliated, name, content, messageCategory, messageStatus, senderEmail, allowResponses, beneficiaryId } = body;
        ...
        if (role === 'beneficiary') {
            ...
            if (messageStatus === 'published' && !canPublish(role)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'You cannot publish messages'
                }, {
                    status: 403
                });
            }
            ...
            if (beneficiaryId) {
                const exists = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findUnique({
                    where: {
                        id: beneficiaryId
                    },
                    select: {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.update({
            where: {
                id: Number(params.id) || params.id
            },
            data: updateData,
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(BENEFICIARIES_ALL_KEY);
            const touchedBeneficiaryIds = new Set();
            ...
            for (const bid of touchedBeneficiaryIds){
                // per-id cache
                await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(`${BENEFICIARY_BY_ID_PREFIX}${bid}`);
                // name-scoped cache
                const b = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findUnique({
                    where: {
                        id: bid
                    },
                    select: {
                ...
                if (b?.firstName && b?.lastName) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(ownCacheKey(b.firstName, b.lastName));
                }
            }
        } catch (err) {
...
async function DELETE(_req, context) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.delete({
            where: {
                id: Number(params.id) || params.id
            }
        });
        ...
        try {
            ...
            if (existing.beneficiaryId) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(`${BENEFICIARY_BY_ID_PREFIX}${existing.beneficiaryId}`);
                const b = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findUnique({
                    where: {
                        id: existing.beneficiaryId
                    },
                    select: {
                        firstName: true,
                        lastName: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff962136._.js.map