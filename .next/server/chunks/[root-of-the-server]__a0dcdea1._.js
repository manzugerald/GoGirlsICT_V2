...
"[project]/.next-internal/server/app/api/beneficiaries/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "d9cbe431b2368bf8eb9f9417bc5b3979bba1ad761d0c93f7ec9dce205d2bee94",
    "copyEngine": true
};
...
"[project]/app/api/beneficiaries/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const SINGLE_BENEFICIARY_CACHE_PREFIX = 'beneficiaries:';
// Helper to save uploaded images (profile/message)
async function saveBeneficiaryFiles(formData, field, destDir) {
...
async function GET(_req, context) {
    try {
        ...
        // add counts
        const [messageCount, responseCount] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.count({
                where: {
                    beneficiaryId: beneficiary.id
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.count({
                where: {
                    message: {
                        beneficiaryId: beneficiary.id
                    }
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(singleCacheKey, JSON.stringify(payload), 'EX', 60 * 60 * 24 * 7);
...
async function PATCH(_req, context) {
    try {
        ...
        const beneficiaryRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findUnique({
            where: {
                id
            },
            select: {
        ...
        if (!isOwner && !isPrivileged) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Forbidden: You can only update your own beneficiary profile or must be privileged'
            }, {
                status: 403
            });
        }
        ...
        const gender = formData.get('gender') || undefined;
        ...
        if (imagesRaw) {
            try {
                existingImages = JSON.parse(imagesRaw) || [];
            } catch  {
                existingImages = [];
            }
        }
        ...
        if (imagesToRemoveRaw) {
            try {
                imagesToRemove = JSON.parse(imagesToRemoveRaw) || [];
            } catch  {
                imagesToRemove = [];
            }
        }
        // Upload new profile images
        const newImageUrls = await saveBeneficiaryFiles(formData, 'newImages', __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'assets', 'images', 'beneficiaries'));
        const images = [
            ...existingImages || [],
            ...newImageUrls
        ...
        // Update beneficiary
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.update({
            where: {
                id
            },
            data: {
        ...
        // Invalidate caches
        await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(SINGLE_BENEFICIARY_CACHE_PREFIX + id),
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(ALL_BENEFICIARIES_CACHE_KEY)
        ]);
        // attach counts
        const [messageCount, responseCount] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.count({
...
async function DELETE(_req, context) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.deleteMany({
            where: {
                message: {
                    beneficiaryId: id
                }
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.deleteMany({
            where: {
                beneficiaryId: id
            }
        });
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a0dcdea1._.js.map