...
async function GET() {
    try {
        ...
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(BENEFICIARIES_ALL_KEY);
        if (cached) {
        ...
        const normalized = beneficiaries.map((b)=>{
            ...
            // Return both original fields and convenience names
            return {
                ...b,
                messageCount,
                responseCount
        ...
        // Cache and return
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(BENEFICIARIES_ALL_KEY, JSON.stringify(normalized), 'EX', CACHE_TTL);
        ...
        console.error('GET /api/beneficiaries error:', err);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fe0a6da4._.js.map