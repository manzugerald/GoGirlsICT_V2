...
async function GET() {
    try {
        ...
        const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.findMany({
            where,
            orderBy: {
                createdAt: 'desc'
            },
...
async function POST(req) {
    try {
        ...
        const { beneficiaryId, title, affiliated, name, content, messageCategory, messageStatus, senderEmail, allowResponses } = body;
        if (!title) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (isMessageCategory(messageCategory)) {
            ...
            if (messageCategory === 'system' && role !== 'super') {
                ...
                resolvedCategory = messageCategory;
            }
        } else {
        ...
        const resolvedStatus = role === 'beneficiary' ? 'draft' : isPublishStatus(messageStatus) ? messageStatus : 'draft';
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.create({
            data: {
        ...
        try {
            ...
            if (created.beneficiaryId) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(`${BENEFICIARY_BY_ID_PREFIX}${created.beneficiaryId}`);
                // delete name-scoped cache if we can resolve names
                const beneficiary = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findUnique({
                    where: {
                        id: created.beneficiaryId
                    },
                    select: {
                        firstName: true,
                        lastName: true
                ...
                if (beneficiary?.firstName && beneficiary?.lastName) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(ownCacheKey(beneficiary.firstName, beneficiary.lastName));
                }
            }
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8e1d426._.js.map