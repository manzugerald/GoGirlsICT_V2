...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next-auth/index.js [app-route] (ecmascript)");
// IMPORTANT: import from a plain module, not from the auth route, to avoid circulars
...
;
;
const runtime = 'nodejs'; // Prisma requires Node runtime
const USERS_CACHE_KEY = 'users:all'; // cache only for privileged roles
const USERS_CACHE_TTL = 10 * 60; // 10 minutes
...
async function GET() {
    try {
        ...
        if (!canViewUsers(role)) {
            // choose one: empty list (soft) or 403 (hard). Using 403 here.
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Forbidden'
            }, {
                status: 403
            });
        // Or: return NextResponse.json([], { status: 200 });
        }
        // Use cache only for roles that can view
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(USERS_CACHE_KEY);
        if (cached) {
            try {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](cached, {
                    headers: {
                        'content-type': 'application/json'
                    }
                });
            } catch  {
                await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(USERS_CACHE_KEY);
            }
        }
        ...
        // stringify once so Dates/BigInts are safe in cache
        const safe = JSON.stringify(users, jsonReplacer);
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(USERS_CACHE_KEY, safe, 'EX', USERS_CACHE_TTL);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](safe, {
            headers: {
                'content-type': 'application/json'
            }
        });
...
async function POST(req) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
    if (getRole(session) !== 'super') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Forbidden: Only super can create users'
        }, {
            status: 403
        });
    }
    ...
    // Bust list cache after mutation
    await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(USERS_CACHE_KEY);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'User created',
        user
    });
} // app/api/beneficiaryRequestResponse/route.ts
}}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__3dea1cb7._.js.map