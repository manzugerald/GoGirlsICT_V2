...
async function PATCH(req, { params }) {
    // Use getServerSession and authOptions for authentication
    ...
    // Only super/admin can update any user, others can only update their own
    ...
    const newRole = formData.get('role'); // <-- ADDED
    if (username) {
...
async function DELETE(req, { params }) {
    ...
    if (role !== 'super') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Forbidden: Only super can delete users'
        }, {
            status: 403
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2910ea5._.js.map