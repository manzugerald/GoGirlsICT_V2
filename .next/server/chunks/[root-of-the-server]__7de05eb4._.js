...
"[project]/.next-internal/server/app/api/beneficiaryMessages/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/beneficiaryMessages/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ALL_CACHE_KEY = 'beneficiaryMessages:all';
const SINGLE_CACHE_PREFIX = 'beneficiaryMessages:';
...
async function GET(_req, { params }) {
    try {
        ...
        const role = asRole(session?.user?.role);
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryMessage.findUnique({
            where: {
                id: params.id
            },
            include: {
...
async function PATCH(req, { params }) {
    try {
        ...
        const role = asRole(session.user.role);
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryMessage.findUnique({
            where: {
                id: params.id
            },
            select: {
        ...
        let { title, beneficiaryMessageText, status } = body;
        // Beneficiary: can only edit own message, and cannot publish
        if (role === 'beneficiary') {
            const ownId = await getOwnBeneficiaryIdFromSession(session);
            ...
            if (status && status !== 'draft' && status !== 'published') status = undefined;
        }
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryMessage.update({
            where: {
                id: params.id
            },
            data: {
                ...
                ...beneficiaryMessageText !== undefined ? {
        ...
        // await Promise.all([redis.del(SINGLE_CACHE_PREFIX + params.id), redis.del(ALL_CACHE_KEY)]);
...
async function DELETE(_req, { params }) {
    try {
        ...
        const role = asRole(session.user.role);
        if (!canDelete(role)) {
            // beneficiaries (and moderators) cannot delete
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Forbidden'
            }, {
                status: 403
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryMessage.delete({
            where: {
                id: params.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7de05eb4._.js.map