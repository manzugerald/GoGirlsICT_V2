...
"[project]/.next-internal/server/app/api/beneficiaryRequests/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/beneficiaryRequests/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const CACHE_KEY = 'beneficiaryRequests:all';
const CACHE_TTL = 60; // 60 seconds
async function GET() {
    try {
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(CACHE_KEY);
        if (cached) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(JSON.parse(cached));
        const requests = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequest.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            include: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(CACHE_KEY, JSON.stringify(requests), 'EX', CACHE_TTL);
...
async function POST(req) {
    try {
        ...
        const { beneficiaryId, title, beneficiaryRequestText, status } = body;
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequest.create({
            data: {
                beneficiaryId,
                title,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(CACHE_KEY);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ddb8b3ad._.js.map