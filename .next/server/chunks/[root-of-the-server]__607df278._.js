...
"[project]/lib/hibp.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function isPwned(password) {
    const sha1 = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHash('sha1').update(password).digest('hex').toUpperCase();
...
async function sendPasswordChangeEmail(to, opts) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hibp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/hibp.ts [app-route] (ecmascript)");
...
// const CACHE_TTL = 60 * 60 * 24 * 7; // 7 days (redis disabled)
...
async function PATCH(req, { params }) {
    try {
        ...
        const username = formData.get('username') ?? null; // original username (optional)
        const newUsername = formData.get('newUsername') ?? null; // desired username (optional)
        ...
        // If a password is provided, run the secure change-password flow here (user-initiated)
        if (password) {
            // Require currentPassword in form data for safety (user must prove identity)
            ...
            const ok = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(currentPassword, user.password);
            if (!ok) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            // Prevent reuse: check against history + current
            const historyRows = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].passwordHistory.findMany({
                where: {
                    userId
                },
                orderBy: {
            ...
            for (const h of hashesToCheck){
                if (!h) continue;
                const match = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(password, h);
                if (match) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            // HIBP check
            try {
                const { pwned, count } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hibp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isPwned"])(password);
                if (pwned) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            // Hash and perform transactional update similar to change-password endpoint
            const newHash = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].hash(password, BCRYPT_ROUNDS);
            const now = new Date();
            await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
                if (user.password) {
                ...
                // revoke active sessions and mark inactive
            ...
            if (user.email) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendPasswordChangeEmail"])(user.email, {
        ...
        if (newUsername && newUsername !== user.username) {
            // check availability
            const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
                where: {
        ...
        } else if (!newUsername && formData.has('username') && username) {
        // If client sent 'username' intending to update (edge case), we allow it only if it equals current username
        ...
        if (imageFile && imageFile.size > 0) {
            ...
            if (oldImageUrl) {
                try {
                    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', oldImageUrl);
            ...
            const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public/assets/images/users');
        ...
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
            where: {
                id: userId
            },
            data: updateData,
...
async function DELETE(_req, { params }) {
    try {
        ...
        if (user.image) {
            try {
                const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', user.image);
                await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].unlink(filePath);
            } catch (e) {
            // It's ok if the file doesn't exist, continue
            }
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.delete({
            where: {
                id: userId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__607df278._.js.map