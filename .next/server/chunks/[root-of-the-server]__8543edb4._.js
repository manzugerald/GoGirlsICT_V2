...
async function POST(req) {
    try {
        ...
        const { slug, eventTitle, eventDescription, eventDetails, eventLocation, eventBanner, eventImages, eventFile, eventStartDate, eventEndDate, eventTags, eventStatus, publishStatus, eventAttendance, maxAttendees, projectId, reportId } = data;
        // Required fields validation
        if (!slug || !eventTitle || !eventDescription || !eventBanner || !eventStartDate || !eventEndDate) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const event = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.create({
            data: {
                slug,
                eventTitle,
                eventDescription,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8543edb4._.js.map