...
"[project]/.next-internal/server/app/api/homepage-content/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/homepage-content/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (contentType.includes('multipart/form-data')) {
            ...
            // Use shared helper to save the video file (field "file"). eventSlug 'homePage' => public/assets/videos/homePage
        ...
        // upload-only flow: return the saved file URL so client can later submit the full form
        ...
        // For DB row creation we require all fields
        ...
        // Provide a clear 413 response when Next.js body parsing limit is hit
...
//# sourceMappingURL=%5Broot-of-the-server%5D__92c4b7bd._.js.map