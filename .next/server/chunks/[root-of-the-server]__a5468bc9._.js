...
"[project]/.next-internal/server/app/api/responses/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/responses/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const canAdminDelete = (role)=>role === 'super' || role === 'admin';
async function GET(_req, context) {
    try {
        // Per Next.js dynamic API rules, params must be awaited
        const params = await context.params;
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.findUnique({
            where: {
                id: params.id
            },
            include: {
...
async function PATCH(req, context) {
    try {
        ...
        const role = asRole(session.user.role);
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.findUnique({
            where: {
                id: params.id
            },
            select: {
        ...
        let allowed = false;
        const roleEnum = existing.responderRole;
        if (canAdminDelete(role)) {
            allowed = true;
        } else if (roleEnum === 'USER') {
            allowed = existing.responderUserId === session.user.id;
        } else if (roleEnum === 'AUTHOR') {
            const isCreator = !!(existing.message?.createdById && session.user.id === existing.message.createdById);
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.update({
            where: {
                id: params.id
            },
            data: {
...
async function DELETE(_req, context) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].response.delete({
            where: {
                id: params.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a5468bc9._.js.map