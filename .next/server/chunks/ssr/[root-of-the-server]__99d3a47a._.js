...
function CreateMessageForm({ messageId, editId, initialValues, onSuccess, onCancel }) {
    ...
    const effectiveEditId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>normalizeId(editId) || normalizeId(initialValues?.id), [
        editId,
        initialValues?.id
    ]);
    ...
    const [loadingInitial, setLoadingInitial] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(isEditing && !initialValues);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (isEditing && effectiveEditId) {
            ...
            fetch(`/api/messages/${effectiveEditId}`).then((res)=>{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: messageKindOptions.map((mk)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: mk,
                                        children: mk
                                    }, mk, false, {
                                        fileName: "[project]/app/(admin)/admin/dashboard/createMessageForm.tsx",
...
function MessageView({ data, onClose, onRespond }) {
    ...
    // split responses by responderRole === 'AUTHOR'
    const authorResponses = Array.isArray(data.responses) ? data.responses.filter((r)=>r.responderRole === 'AUTHOR' || r.responderUser?.id && data.createdBy?.id && r.responderUser.id === data.createdBy.id) : [];
    const otherResponses = Array.isArray(data.responses) ? data.responses.filter((r)=>!(r.responderRole === 'AUTHOR' || r.responderUser?.id && data.createdBy?.id && r.responderUser.id === data.createdBy.id)) : [];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: authorResponses.map((r)=>{
                                    const isAuthor = r.responderRole === 'AUTHOR' || r.responderUser?.id && data.createdBy?.id && r.responderUser.id === data.createdBy.id;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/utils/isResponderAuthor.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
// Utility to determine whether a response was made by the same person who created the message.
//
// Compares in this priority order:
// 1. If both message.createdBy.id and responderUser.id are present -> compare ids (exact).
// 2. If the message is tied to a beneficiary and responder is a beneficiary -> compare beneficiary ids.
// 3. If both emails are present -> compare emails (case-insensitive, trimmed).
// 4. If first+last name present on both sides -> compare normalized names (case-insensitive, trimmed).
// 5. If message has a `name` free-text (visitor name) and responder has a beneficiary/user name -> compare that.
// Returns true when we have sufficient matching evidence that the responder is the message author.
//
// Accepts partial objects (handles missing fields).
__turbopack_context__.s({
    "isResponderAuthor": (()=>isResponderAuthor)
});
function isResponderAuthor(args) {
    const { message, responder } = args;
    if (!message || !responder) return false;
    const msgUser = message.createdBy ?? null;
    const msgBen = message.beneficiary ?? null;
    const msgName = typeof message.name === 'string' ? message.name.trim() : '';
    const msgEmail = typeof message.senderEmail === 'string' ? message.senderEmail.trim().toLowerCase() : '';
    const resUser = responder.responderUser ?? null;
    const resBen = responder.responderBeneficiary ?? null;
    // 1) ID exact match for createdBy user vs responder user
    if (msgUser?.id && resUser?.id) {
        if (String(msgUser.id) === String(resUser.id)) return true;
    }
    // 2) If message is tied to a beneficiary and responder is a beneficiary, compare beneficiary ids
    if (msgBen?.id && resBen?.id) {
        if (String(msgBen.id) === String(resBen.id)) return true;
    }
    // Helper normalizers
    const normalize = (s)=>(s ?? '').trim().toLowerCase();
    const fullName = (first, last)=>`${(first ?? '').trim()} ${(last ?? '').trim()}`.trim();
    // 3) Email match (message creator email vs responder user email OR message.senderEmail vs responder email)
    const msgCreatorEmail = normalize(msgUser?.email ?? msgEmail);
    const resUserEmail = normalize(resUser?.email ?? undefined);
    if (msgCreatorEmail && resUserEmail && msgCreatorEmail === resUserEmail) return true;
    // 4) Name match: compare createdBy name to responder names
    const msgCreatorName = normalize(fullName(msgUser?.firstName, msgUser?.lastName));
    const resUserName = normalize(fullName(resUser?.firstName, resUser?.lastName));
    if (msgCreatorName && resUserName && msgCreatorName === resUserName) return true;
    // 5) Compare message.name (visitor-supplied) to responder beneficiary/user name
    const msgNameNorm = normalize(msgName);
    if (msgNameNorm) {
        if (resUserName && msgNameNorm === resUserName) return true;
        const resBenName = normalize(fullName(resBen?.firstName, resBen?.lastName));
        if (resBenName && msgNameNorm === resBenName) return true;
    }
    // 6) As a last fallback, compare message.senderEmail (visitor email) to responder user email
    const msgSenderEmail = normalize(message.senderEmail ?? undefined);
    if (msgSenderEmail && resUserEmail && msgSenderEmail === resUserEmail) return true;
    return false;
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/shared/lib/app-dynamic.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next-auth/react/index.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$isResponderAuthor$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/isResponderAuthor.ts [app-ssr] (ecmascript)");
;
'use client';
;
;
...
function ResponseView({ data, onClose }) {
    ...
    // 1) If responderRole === 'AUTHOR' server-side (definitive)
    // 2) Or if heuristic detects responder matches message author (via user id/email/name or beneficiary id)
    // 3) Or when the current viewer is a beneficiary and the responder is that same beneficiary (session match)
    const isAuthorHeuristic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$isResponderAuthor$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isResponderAuthor"])({
        message: {
            createdBy: data.message?.createdBy ?? (data.message?.createdById ? {
                id: data.message.createdById
            } : undefined),
            beneficiary: data.message?.beneficiary ?? undefined,
            name: data.message?.name ?? undefined,
            senderEmail: data.message?.senderEmail ?? undefined
        },
        responder: {
            responderUser: data.responderUser ?? undefined,
            responderBeneficiary: data.responderBeneficiary ?? undefined
        }
    });
    // Check if the current logged-in session corresponds to the same beneficiary as the responder.
    // We can't rely on a beneficiary id in session, so compare session first/last name to responderBeneficiary when role === 'beneficiary'
    const sessionIsSameBeneficiary = (()=>{
        try {
            if (!session?.user) return false;
            const role = session.user.role ?? 'guest';
            if (role !== 'beneficiary') return false;
            const sf = (session.user.firstName ?? '').trim().toLowerCase();
            const sl = (session.user.lastName ?? '').trim().toLowerCase();
            const rb = data.responderBeneficiary;
            if (!rb) return false;
            const rbFirst = (rb.firstName ?? '').trim().toLowerCase();
            const rbLast = (rb.lastName ?? '').trim().toLowerCase();
            if (!sf || !sl) return false;
            return sf === rbFirst && sl === rbLast;
        } catch  {
            return false;
        }
    })();
    const isAuthor = data.responderRole === 'AUTHOR' || isAuthorHeuristic || sessionIsSameBeneficiary;
    // If responderRole exists and not AUTHOR, use it; when response is authored by message creator we show AUTHOR badge
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$sections$2f$ResponsesSection$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(admin)/admin/dashboard/components/sections/ResponsesSection.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$createMessageForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(admin)/admin/dashboard/createMessageForm.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$createResponseForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(admin)/admin/dashboard/createResponseForm.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$views$2f$responseView$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(admin)/admin/dashboard/components/views/responseView.tsx [app-ssr] (ecmascript)");
...
function AdminDashboardPage() {
    ...
    const sectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])('charts');
    ...
    function renderSection() {
        if (viewRecord) {
            switch(activeSection){
                ...
                case 'responses':
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$views$2f$responseView$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        data: viewRecord,
                        onClose: handleCloseView
                    }, void 0, false, {
                        fileName: "[project]/app/(admin)/admin/dashboard/page.tsx",
        ...
        if (editRecord) {
            switch(activeSection){
                ...
                case 'responses':
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$createResponseForm$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
        ...
        switch(activeSection){
            ...
            case 'responses':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$sections$2f$ResponsesSection$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    paginatedData: paginatedData,
                    page: page,
                    rowsPerPage: rowsPerPage,
                    handleEdit: handleEdit,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    !hideControls && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: showToolControls ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(TableControls, {
                            search: search,
                            setSearch: setSearch,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__99d3a47a._.js.map