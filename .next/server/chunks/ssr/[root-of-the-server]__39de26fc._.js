...
;
;
function AdminSection({ paginatedData, page, rowsPerPage, handleEdit, handleView, handleDelete, messagesCountMap, responsesCountMap, currentUserRole, TableActions, onAddMessage }) {
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>[
            {
                id: 'number',
                header: 'No.',
...
function CreateOrEditUserForm({ mode = 'create', userId, initialData, onSuccess, onCancel, onDelete }) {
    ...
    // Extra UI toggles for editing username/password separately
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    // Sync with incoming initialData
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setForm({
            firstName: initialData?.firstName || '',
            lastName: initialData?.lastName || '',
        ...
        // reset username/password toggles
    ...
    // Username validation for update (optional; expects an API that returns { valid: boolean } for exact match/availability)
    const handleUsernameBlur = async ()=>{
        if (!form.username) return;
        // In edit mode: we may validate that the visible username matches DB if the server expects that.
        // In create mode: we could check availability.
        try {
            setCheckingUsername(true);
            // Attempt a lightweight check endpoint — it's optional; if endpoint not present this will fail silently.
            ...
            if (!res.ok) {
                // ignore server errors for this optional check
                setUsernameInvalid(false);
                setCheckingUsername(false);
                return;
            }
            const data = await res.json().catch(()=>null);
            // For edit-check we expect { valid: true } meaning the provided username matches DB (if server requires)
            // For create-check we expect { available: true } or { valid: true }. We'll treat both shapes.
    ...
    const handleImageDelete = async ()=>{
        ...
        if (userId && imageUrl) {
            // best-effort request to remove image on server — endpoint optional
            try {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (mode === 'create') {
            ...
            // If user wants to change username, validate input
            if (changeUsername) {
        ...
        try {
            ...
            // For create: username is the chosen username
            // For edit: keep current username visible in form.username; only send 'username' field if changeUsername is true (server-side may expect different shapes)
            if (mode === 'create') {
                formData.append('username', form.username);
            } else {
                // include the visible username (required by some server checks) and also include newUsername if changing
                formData.append('username', form.username || '');
                if (changeUsername) {
                    // include both fields to allow server-side logic to verify current vs new username
            ...
            if (mode === 'create') {
                ...
                // in edit mode, only include `password` when changing
                if (changePassword) {
                    formData.append('password', newPassword);
                } else if (form.password) {
                    // legacy: if user typed into the main password field, use it
                    formData.append('password', form.password);
                }
            }
            ...
            // If username change was requested and server returned the updated user, reflect it locally
            if (mode === 'edit' && data?.user) {
                // call optional onSuccess for parent to refresh list
                if (onSuccess) onSuccess();
            }
            if (mode === 'create') {
                ...
                // update local preview with returned user if provided
                if (data?.user) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            disabled: isSubmitting || checkingUsername || usernameInvalid || mode === 'create' && form.password !== form.confirmPassword || mode === 'edit' && changePassword && newPassword !== confirmNewPassword || mode === 'edit' && changeUsername && newUsername !== confirmNewUsername,
                            children: [
                ...
                mode === 'edit' && userId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/app/(admin)/admin/dashboard/components/views/adminView.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '@/components/sections/AdminsSection'");
...
function AdminView() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/app/(admin)/admin/dashboard/components/views/adminView.tsx",
                        lineNumber: 116,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AdminsSection, {
                paginatedData: users,
                page: 1,
                rowsPerPage: 100,
                handleEdit: (u)=>{
                    // For now, reuse create dialog to show/edit? Left as a placeholder
                    console.log('Edit user', u);
                },
                handleView: (u)=>{
                    // view details: open a simple dialog (not implemented here)
                    alert(`User: ${u.username}\nName: ${u.firstName ?? ''} ${u.lastName ?? ''}\nEmail: ${u.email ?? ''}`);
                },
                handleDelete: (id)=>{
                    // deletion endpoint not provided in route snippet; implement as needed
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$views$2f$adminView$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(admin)/admin/dashboard/components/views/adminView.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
// Keep only these sections in the dashboard (added 'users')
const sections = [
    'beneficiaries',
    'messages',
    'responses',
    ...
    function renderSection() {
        if (viewRecord) {
            switch(activeSection){
                ...
                case 'users':
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$views$2f$adminView$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                        fileName: "[project]/app/(admin)/admin/dashboard/page.tsx",
                        lineNumber: 398,
                        columnNumber: 18
                    }, this);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__39de26fc._.js.map