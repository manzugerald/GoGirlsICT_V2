...
function beneficiaryColumns({ onEdit, onView, onDelete, onAddMessage, onMessageIdClick, messagesCountMap, responsesCountMap, currentUserRole }) {
    const cols = [
        ...
        },
        {
            id: 'responsesCount',
            header: 'Responses',
            cell: ({ row })=>responsesCountMap && row.original.id ? responsesCountMap[row.original.id] || 0 : 0
        },
        {
            accessorKey: 'createdAt',
            header: 'Created At',
...
(()=>{
    const e = new Error("Cannot find module '@/app/admin/dashboard/createMessageForm'");
...
function BeneficiariesSection({ paginatedData, page, rowsPerPage, handleEdit, handleView, handleDelete, messagesCountMap: initialMessagesCountMap, responsesCountMap: initialResponsesCountMap, currentUserRole, TableActions, onAddMessage: externalOnAddMessage }) {
    ...
    // The existing CreateMessageForm fires onSuccess without a payload, so we fetch counts server-side.
    const handleCreateSuccess = async (beneficiaryId)=>{
        ...
        try {
            ...
            const msgCount = typeof json.messageCount === 'number' ? json.messageCount : undefined;
            const respCount = typeof json.responseCount === 'number' ? json.responseCount : undefined;
    ...
    // Provide onAddMessage to columns so Add Message button opens our modal
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            openAddMessageFor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Modal, {
...
"[project]/utils/responseView.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
// 2. If both emails are present -> compare emails (case-insensitive, trimmed).
// 3. If first+last name present on both sides -> compare normalized names (case-insensitive, trimmed).
// 4. If message has a `name` free-text (visitor name) and responder has a beneficiary/user name -> compare that.
...
function isResponderAuthor(args) {
    ...
    // 2) Email match (message creator email vs responder user email OR message.senderEmail vs responder email)
    ...
    // 3) Name match: compare createdBy name to responder names
    ...
    // 4) Compare message.name (visitor-supplied) to responder beneficiary/user name
    ...
    // 5) As a last fallback, compare message.senderEmail (visitor email) to responder user email
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/shared/lib/app-dynamic.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next-auth/react/index.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$responseView$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/responseView.ts [app-ssr] (ecmascript)");
;
'use client';
;
;
...
function ResponseView({ data, onClose }) {
    ...
    const isAuthor = data.responderRole === 'AUTHOR' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$responseView$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isResponderAuthor"])({
        message: {
            // prefer createdBy object if present, otherwise pass createdById so helper can compare IDs
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c47989e7._.js.map