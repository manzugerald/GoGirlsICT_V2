...
function CreateOrEditUserForm({ mode = 'create', userId, initialData, onSuccess, onCancel, onDelete }) {
    ...
    // store the original data for comparison so we only send changed fields in edit mode
    const initialRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(initialData);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        initialRef.current = initialData;
    }, [
        initialData
    ]);
    // Determine "isEdit" from props or presence of userId/initialData to avoid relying only on passed mode
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!isEdit) {
            ...
            // edit mode: fields optional, validate only if changeUsername/changePassword toggles are used
            if (changeUsername) {
        ...
        try {
            ...
            if (!isEdit) {
                // CREATE: include required fields
                ...
                // EDIT mode: include only changed fields compared to initialData (initialRef.current)
                const orig = initialRef.current ?? {};
                // include original current username (helpful for server-side checks)
                if (orig.username) {
                    formData.append('username', orig.username);
                ...
                // username change flow (explicit)
                if (changeUsername) {
                    formData.append('newUsername', newUsername);
                }
                // password change flow (explicit)
                if (changePassword) {
                ...
                if (imageToDelete) {
                    formData.append('oldImageUrl', imageToDelete);
                }
            }
            let res;
            if (isEdit) {
                res = await fetch(`/api/users/${encodeURIComponent(String(userId))}`, {
                    method: 'PATCH',
                    body: formData
                });
            } else {
            ...
            if (!isEdit) {
                ...
                if (data?.user) {
                    ...
                    // update initialRef so future edits compare against latest state
                    initialRef.current = {
                        ...initialRef.current || {},
                        ...data.user
                    };
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
            ...
            children: [
                ...
                isEdit && userId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function SettingsSection({ currentUserId, onOpenEdit }) {
    ...
    async function fetchUser() {
        ...
        setError(null);
        try {
            const res = await fetch(`/api/users/${encodeURIComponent(String(currentUserId))}`);
            if (!res.ok) {
    ...
    function handleOpenEdit() {
        if (!user) {
            // try to fetch then open
            fetchUser().then(()=>setOpenEditModal(true));
        } else {
            setOpenEditModal(true);
        }
        if (onOpenEdit && user) onOpenEdit(user);
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Edit your profile or change your password."
                            }, void 0, false, {
                                fileName: "[project]/app/(admin)/admin/dashboard/components/sections/SettingsSection.tsx",
                                lineNumber: 61,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                onClick: ()=>{
                                    // Open the same edit form — user can use the "Change password" toggle
                                    handleOpenEdit();
                                },
                                disabled: !currentUserId || loading,
                                variant: "outline",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: openEditModal && user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    function renderSection() {
        if (viewRecord) {
            switch(activeSection){
                ...
                case 'users':
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(UserView, {}, void 0, false, {
                        fileName: "[project]/app/(admin)/admin/dashboard/page.tsx",
                        lineNumber: 410,
                        columnNumber: 18
                    }, this);
                case 'settings':
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$admin$292f$admin$2f$dashboard$2f$components$2f$sections$2f$SettingsSection$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        onOpenEdit: (user)=>{
                            // open edit UI in main dashboard area if desired (we keep SettingsSection self-contained)
                            setEditRecord(user);
                            setHideControls(true);
                        }
                    }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cbdefbcc._.js.map