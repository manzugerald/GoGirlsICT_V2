...
function AdminLoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginAndSync"])({
                identifier: username,
                password,
                callbackUrl
            });
    ...
    const handleLogout = async ()=>{
        ...
        setError('');
        try {
            const r = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logoutAndSync"])();
            if (!r.ok) {
