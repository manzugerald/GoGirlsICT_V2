...
"[project]/.next-internal/server/app/api/beneficiaryRequestResponse/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/beneficiaryRequestResponse/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
// import { redis } from '@/utils/redis'; // Uncomment if you want caching
const CACHE_KEY = 'beneficiaryRequestResponses:all';
...
async function GET() {
    try {
        ...
        const where = role === 'beneficiary' && firstName && lastName ? {
            // Only responses for requests that belong to the beneficiary
            request: {
                beneficiary: {
                    firstName,
                    lastName
        ...
        const responses = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequestResponse.findMany({
            where,
            orderBy: {
                respondedAt: 'desc'
            },
...
async function POST(req) {
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequestResponse.create({
            data: {
                responseId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bf087649._.js.map