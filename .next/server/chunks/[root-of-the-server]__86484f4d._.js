...
"[project]/.next-internal/server/app/api/beneficiaries/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                const valid = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(credentials.password, user.password);
                if (!valid) {
...
"[project]/utils/redis.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const redis = globalForRedis.redis || new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ioredis$2f$built$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](process.env.REDIS_URL || 'redis://localhost:6379');
if ("TURBOPACK compile-time truthy", 1) {
    globalForRedis.redis = redis;
}
}}),
"[project]/app/api/beneficiaries/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function namesFrom(session) {
    return {
        firstName: session?.user?.firstName ?? undefined,
        lastName: session?.user?.lastName ?? undefined
    };
}
function ownCacheKey(firstName, lastName) {
    return `${BASE_CACHE_KEY}:own:${encodeURIComponent(firstName)}|${encodeURIComponent(lastName)}`;
}
async function saveFiles(formData, field, destDir) {
    const files = formData.getAll(field);
    const savedNames = [];
    if (files && files.length > 0) {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].mkdir(destDir, {
            recursive: true
        });
        for (const file of files){
            if (!file || typeof file === 'string') continue;
            const ext = (file.name.split('.').pop() || 'jpg').toLowerCase();
            const filename = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$node$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}.${ext}`;
            const buffer = Buffer.from(await file.arrayBuffer());
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(destDir, filename), buffer);
...
async function GET() {
    try {
        ...
        if (role === 'beneficiary') {
            ...
            if (!fn || !ln) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json([]);
            const beneficiaries = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findMany({
                where: {
                    firstName: {
                        equals: fn,
                        mode: 'insensitive'
        ...
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(keyAll);
        if (cached) {
            try {
                const parsed = JSON.parse(cached);
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(Array.isArray(parsed) ? parsed : []);
            } catch  {
                await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(keyAll);
            }
        }
        const all = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            include: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(keyAll, JSON.stringify(enrichedAll), 'EX', CACHE_TTL);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(enrichedAll);
    } catch (err) {
...
async function POST(req) {
    try {
        ...
        const institutionId = formData.get('institutionId') || undefined;
        ...
        const destDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'assets', 'images', 'beneficiaries');
        ...
        const beneficiary = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiary.create({
            data: {
                firstName,
                lastName,
                gender,
        ...
        // Invalidate caches
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(`${BASE_CACHE_KEY}:all`);
        // also invalidate potential name-scoped cache for the created beneficiary
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(ownCacheKey(firstName, lastName));
        // add convenience counts on response
        const messageCount = typeof beneficiary._count?.messages === 'number' ? beneficiary._count.messages : 0;
        const responseCount = typeof beneficiary._count?.responses === 'number' ? beneficiary._count.responses : 0;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...beneficiary,
            messageCount,
            responseCount
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86484f4d._.js.map