 ...
 */ const config = {
    ...
    "inlineSchemaHash": "b49eae7b06cca9c80d6b9697ce8d75bdfb5b9db49b9d4e2926168edbb418b0e0",
    "copyEngine": true
};
...
async function GET() {
    try {
        console.log('[BeneficiaryMessages][GET] Checking redis cache...');
        ...
        if (cached) {
            console.log('[BeneficiaryMessages][GET] Returning cached result.');
        ...
        console.log('[BeneficiaryMessages][GET] Querying database...');
        ...
        console.log('[BeneficiaryMessages][GET] DB Result:', JSON.stringify(messages, null, 2));
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(CACHE_KEY, JSON.stringify(messages), 'EX', CACHE_TTL);
        console.log('[BeneficiaryMessages][GET] Cached new result.');
        ...
        console.error('[BeneficiaryMessages][GET] ERROR:', error);
...
async function POST(req) {
    try {
        console.log('[BeneficiaryMessages][POST] Checking user session...');
        ...
        if (!session?.user?.id) {
            console.warn('[BeneficiaryMessages][POST] Unauthorized attempt.');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Unauthorized'
            }, {
                status: 401
        ...
        console.log('[BeneficiaryMessages][POST] Request body:', body);
        const { beneficiaryId, title, message, status, images } = body;
        if (!beneficiaryId || !title) {
            console.warn('[BeneficiaryMessages][POST] Missing required fields.');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (typeof message === 'string') {
            try {
                messageToSave = JSON.parse(message);
            } catch  {
                // store as string if not JSON
                messageToSave = message;
            }
        }
        console.log('[BeneficiaryMessages][POST] Creating message in DB...');
        ...
        console.log('[BeneficiaryMessages][POST] Created:', created);
        ...
        console.log('[BeneficiaryMessages][POST] Cache invalidated.');
        ...
        console.error('[BeneficiaryMessages][POST] ERROR:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Internal Server Error',
            details: String(error)
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e729bf86._.js.map