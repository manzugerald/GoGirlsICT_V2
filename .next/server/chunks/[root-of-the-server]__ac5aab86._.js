...
"[project]/.next-internal/server/app/api/file-stats/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/file-stats/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function getExactFileSize(dir, filename) {
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(dir)) return 0;
    ...
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(fullPath)) return 0;
...
async function GET() {
    ...
    const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(FILE_STATS_CACHE_KEY);
    if (cached) {
    ...
    for (const project of projects){
        if (Array.isArray(project.images)) {
            ...
            for (const img of project.images){
                ...
                const size = getExactFileSize(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public/assets/images/projects'), filename);
    ...
    for (const event of events){
        if (event.eventBanner && typeof event.eventBanner === 'string') {
            ...
            eventImageSize += getExactFileSize(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public/assets/images/events/first-event'), filename);
        }
        ...
        if (event.eventFile && typeof event.eventFile === 'string') {
            ...
            eventPDFSize += getExactFileSize(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public/assets/pdfs/events/first-event'), filename);
        }
    }
    // --- REPORTS ---
    ...
    for (const report of reports){
        if (Array.isArray(report.images)) {
            ...
            for (const img of report.images){
                const filename = getFilenameFromPath(img);
                reportImageSize += getExactFileSize(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public/assets/images/reports'), filename);
            }
        }
        if (Array.isArray(report.files)) {
            ...
            for (const pdf of report.files){
                ...
                reportPDFSize += getExactFileSize(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public/assets/pdfs/reports'), filename);
            }
        }
    }
    // --- INSTITUTIONS ---
    ...
    for (const institution of institutions){
        ...
        if (Array.isArray(institution.institutionImages)) {
            ...
            for (const img of institution.institutionImages){
                const filename = getFilenameFromPath(img);
                const size = getExactFileSize(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public/uploads/institutions'), filename);
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(FILE_STATS_CACHE_KEY, JSON.stringify(result), 'EX', FILE_STATS_CACHE_TTL);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac5aab86._.js.map