...
"[project]/lib/uploadHelpers.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
async function saveUploadedFiles(formData, field, type, eventSlug// to organize per event (for video, use e.g. 'homePage' or any subfolder)
) {
    ...
    let publicBase = '';
    if (type === 'image') {
        destDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'assets', 'images', 'events', eventSlug);
        publicBase = `/assets/images/events/${eventSlug}`;
    } else if (type === 'pdf') {
        destDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'assets', 'pdfs', 'events', eventSlug);
        publicBase = `/assets/pdfs/events/${eventSlug}`;
    } else {
        // video
        const sub = eventSlug && eventSlug.trim() ? eventSlug : 'homePage';
        destDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'assets', 'videos', sub);
...
async function saveUploadedFile(formData, field, type, eventSlug) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploadHelpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/uploadHelpers.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET() {
    try {
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(HOMEPAGE_CACHE_KEY);
        if (cached) {
        ...
        const homePage = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].homePage.findFirst({
            orderBy: {
                createdAt: 'desc'
            }
        });
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(HOMEPAGE_CACHE_KEY, JSON.stringify(homePage), 'EX', HOMEPAGE_CACHE_TTL);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(homePage);
    } catch (err) {
...
async function POST(req) {
    try {
        ...
        if (contentType.includes('multipart/form-data')) {
            ...
            const saved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploadHelpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUploadedFile"])(form, 'file', 'video', 'homePage');
        ...
        const homePage = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].homePage.create({
            data: {
                heroVideo,
                vision,
                mission,
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(HOMEPAGE_CACHE_KEY);
        } catch (err) {
        ...
        if (err?.message?.includes?.('Body exceeded') || err?.statusCode === 413 || err?.cause && String(err.cause).includes('Body exceeded')) {
            console.error('Request body too large:', err);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Request body too large. Increase server body size limit or upload a smaller file.'
            }, {
                status: 413
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c7dcc6d._.js.map