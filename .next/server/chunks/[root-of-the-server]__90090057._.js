...
"[project]/.next-internal/server/app/api/institutions/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
exports.Prisma.BeneficiaryScalarFieldEnum = {
    ...
    createdAt: 'createdAt',
    updatedAt: 'updatedAt',
    beneficiaryMessageTitle: 'beneficiaryMessageTitle',
    beneficiaryMessageImages: 'beneficiaryMessageImages',
    beneficiaryMessageStatus: 'beneficiaryMessageStatus',
    institutionId: 'institutionId',
    createdById: 'createdById',
    updatedById: 'updatedById',
    approvedById: 'approvedById'
...
"[project]/app/api/institutions/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const institution = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].institution.findUnique({
            where: {
                id: params.id
            },
            include: {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(singleCacheKey, JSON.stringify(institution), 'EX', CACHE_TTL);
...
async function PATCH(req, { params }) {
    try {
        ...
        let headName = formData.get('headName') || '';
        let institutionType = formData.get('institutionType') || '';
        let existingImages = [];
        let imagesToRemove = [];
        let institutionImages = [];
        let newImageUrls = [];
        let logoUrl = null;
        ...
        newImageUrls = await saveInstitutionFiles(formData, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'institutions'));
        // Logo update
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].institution.update({
            where: {
                id: params.id
            },
            data: {
        ...
        await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(SINGLE_INSTITUTION_CACHE_PREFIX + params.id),
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(INSTITUTIONS_ALL_CACHE_KEY)
        ]);
...
async function DELETE(req, { params }) {
    try {
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].institution.delete({
            where: {
                id: params.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90090057._.js.map