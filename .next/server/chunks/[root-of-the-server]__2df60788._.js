...
"[project]/.next-internal/server/app/api/beneficiaryRequests/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/beneficiaryRequests/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
// app/api/beneficiaryRequests/[id]/route.ts
__turbopack_context__.s({
    "DELETE": (()=>DELETE),
    "GET": (()=>GET),
    "PATCH": (()=>PATCH),
...
const ALL_CACHE_KEY = 'beneficiaryRequests:all';
const SINGLE_CACHE_PREFIX = 'beneficiaryRequests:';
const includeShape = {
    beneficiary: {
        select: {
            id: true,
...
async function GET(req, { params }) {
    try {
        const cacheKey = SINGLE_CACHE_PREFIX + params.id;
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(cacheKey);
        if (cached) {
            const parsed = JSON.parse(cached);
            // Guard for beneficiaries even when cached
            ...
            if (session?.user?.role === 'beneficiary') {
                ...
                if (!firstName || !lastName) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'Forbidden'
                }, {
                    status: 403
                });
                if (parsed?.beneficiary?.firstName !== firstName || parsed?.beneficiary?.lastName !== lastName) {
        ...
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequest.findUnique({
            where: {
                id: params.id
            },
        ...
        // Beneficiary can only read their own request
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
        if (session?.user?.role === 'beneficiary') {
            const firstName = session.user?.firstName;
            const lastName = session.user?.lastName;
            ...
            if (data.beneficiary.firstName !== firstName || data.beneficiary.lastName !== lastName) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'Forbidden'
                }, {
                    status: 403
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(cacheKey, JSON.stringify(data), 'EX', 60 * 60 * 24 * 7);
...
async function PATCH(req, { params }) {
    try {
        ...
        // Only the beneficiary (owner) can update
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequest.findUnique({
            where: {
                id: params.id
            },
            include: {
        ...
        if (existing.beneficiary?.createdById !== session.user.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Forbidden: Only the beneficiary can update this request'
            }, {
                status: 403
            });
        }
        const body = await req.json();
        const { title, beneficiaryRequestText, status } = body;
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequest.update({
            where: {
                id: params.id
            },
            data: {
        ...
        await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(SINGLE_CACHE_PREFIX + params.id),
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(ALL_CACHE_KEY)
        ]);
...
async function DELETE(req, { params }) {
    try {
        ...
        // Only the beneficiary (owner) can delete
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequest.findUnique({
            where: {
                id: params.id
            },
        ...
        if (existing.beneficiary?.createdById !== session.user.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Forbidden: Only the beneficiary can delete this request'
            }, {
                status: 403
            });
        }
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequest.delete({
            where: {
                id: params.id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2df60788._.js.map