...
"[project]/.next-internal/server/app/api/locations/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET() {
    try {
        ...
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(LOCATIONS_CACHE_KEY);
        if (cached) {
        ...
        const locations = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].location.findMany({
            orderBy: {
                id: 'desc'
            },
            include: {
        ...
        // Cache the result
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(LOCATIONS_CACHE_KEY, JSON.stringify(locations), 'EX', LOCATIONS_CACHE_TTL);
...
async function POST(req) {
    try {
        ...
        const location = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].location.create({
            data: {
                locationName,
                latitude,
                longitude,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(LOCATIONS_CACHE_KEY);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b214d823._.js.map