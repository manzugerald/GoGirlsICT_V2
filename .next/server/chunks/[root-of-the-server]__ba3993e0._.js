...
async function GET() {
    ...
    if (redisCached) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(JSON.parse(redisCached), {
            status: 200
        });
    }
    // Try to get last fetch timestamp from DB
    let cacheMeta = await prisma.youTubeCacheMeta.findUnique({
        where: {
            id: 1
        }
    });
    ...
    if (cacheMeta && now.getTime() - new Date(cacheMeta.lastFetched).getTime() < CACHE_DURATION_MS) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(REDIS_CACHE_KEY, JSON.stringify(videos), 'EX', REDIS_CACHE_TTL);
    ...
    try {
        const searchResponse = await fetch(`https://www.googleapis.com/youtube/v3/search?key=${API_KEY}&channelId=${CHANNEL_ID}&part=snippet,id&order=date&maxResults=50&type=video`);
        ...
        const videosResponse = await fetch(`https://www.googleapis.com/youtube/v3/videos?key=${API_KEY}&id=${videoIds}&part=snippet,contentDetails,statistics`);
        ...
        // Upsert videos in DB
        const videoData = await Promise.all(videosData.items.map(async (item)=>{
        ...
        // Update Redis cache
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(REDIS_CACHE_KEY, JSON.stringify(videoData), 'EX', REDIS_CACHE_TTL);
        ...
        if (fallbackVideos.length > 0) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(REDIS_CACHE_KEY, JSON.stringify(fallbackVideos), 'EX', REDIS_CACHE_TTL);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(fallbackVideos, {
                status: 200
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba3993e0._.js.map