    ...
    try {
        ...
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].message.create({
            data: {
                ...
                name: name ?? null,
                content: content ?? '',
                // map to the new messageCategory field
                messageCategory: isMessageCategory(messageCategory) ? messageCategory : 'external',
                messageStatus: role === 'beneficiary' ? 'draft' : isPublishStatus(messageStatus) ? messageStatus : 'draft',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b3a1f0f._.js.map