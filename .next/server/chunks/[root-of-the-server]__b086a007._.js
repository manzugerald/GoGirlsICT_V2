 ...
 */ const config = {
    ...
    "inlineSchemaHash": "77a19cfbf0fe5b7253d2ca13364e4ee2aa93603ca1ac5e43e6f616691e6e72c0",
    "copyEngine": true
};
...
async function GET(req, { params }) {
    try {
        ...
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.findUnique({
            where: {
                id: projectId
            }
        });
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(singleCacheKey, JSON.stringify(project), 'EX', CACHE_TTL);
...
async function saveUploadedFiles(formData, destDir) {
...
async function PATCH(req, { params }) {
    try {
        ...
        if (formData) {
            ...
            projectStatus = formData.get('projectStatus') || 'active';
            ...
            newImageUrls = await saveUploadedFiles(formData, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'projects'));
        } else {
        ...
        // Only super/admin can publish, moderator must update as draft
        const finalPublishStatus = publishStatus === 'published' && ![
            'super',
            'admin'
        ].includes(role) ? 'draft' : publishStatus;
        const updatedProject = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.update({
            where: {
                id: projectId
            },
            data: {
        ...
        await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(SINGLE_PROJECT_CACHE_PREFIX + projectId),
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(ALL_PROJECTS_CACHE_KEY)
        ]);
...
async function DELETE(req, { params }) {
    try {
        ...
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.delete({
            where: {
                id: projectId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b086a007._.js.map