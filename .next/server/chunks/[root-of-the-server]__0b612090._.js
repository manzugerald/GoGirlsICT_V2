...
"[project]/.next-internal/server/app/api/beneficiaryRequestResponse/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/beneficiaryRequestResponse/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const ALL_RESPONSES_CACHE_KEY = 'beneficiaryRequestResponses:all';
const SINGLE_RESPONSE_CACHE_PREFIX = 'beneficiaryRequestResponses:';
async function GET(req, { params }) {
    try {
        // Try Redis cache first
        const cacheKey = SINGLE_RESPONSE_CACHE_PREFIX + params.id;
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequestResponse.findUnique({
            where: {
                id: params.id
            },
            select: {
                ...
                responseText: true,
                respondedAt: true,
                responseUpdatedAt: true,
                responderId: true
            }
        });
        if (!response) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Beneficiary Request Response not found'
            }, {
                status: 404
            });
        }
        // Cache result for this response for 7 days
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(cacheKey, JSON.stringify(response), 'EX', 60 * 60 * 24 * 7);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(response);
    } catch (error) {
        console.error('Failed to fetch beneficiary request response:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PATCH(req, { params }) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequestResponse.findUnique({
            where: {
                id: params.id
            },
            select: {
        ...
        // Only allow update by the original responder
        if (existing.responderId !== session.user.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Forbidden: Only the responder can update this response'
            }, {
                status: 403
            });
        }
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequestResponse.update({
            where: {
                id: params.id
            },
            data: {
        ...
        // Invalidate cache
        await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(SINGLE_RESPONSE_CACHE_PREFIX + params.id),
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(ALL_RESPONSES_CACHE_KEY)
        ]);
        ...
        console.error('Failed to update beneficiary request response:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Internal Server Error'
        }, {
            status: 500
...
async function DELETE(req, { params }) {
    try {
        ...
        if (existing.responderId !== session.user.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Forbidden: Only the responder can delete this response'
            }, {
                status: 403
            });
        }
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beneficiaryRequestResponse.delete({
            where: {
                id: params.id
            }
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Deleted',
            beneficiaryRequestResponse: deleted
        });
    } catch (error) {
        if (error.code === 'P2025') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        console.error('Failed to delete beneficiary request response:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Internal Server Error'
        }, {
            status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b612090._.js.map