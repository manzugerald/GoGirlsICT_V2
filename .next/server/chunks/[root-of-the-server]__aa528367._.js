...
"[project]/.next-internal/server/app/api/institutions/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/institutions/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function saveInstitutionFiles(formData, destDir) {
    ...
    if (files && files.length > 0) {
        ...
        for (const file of files){
            ...
            const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(destDir, filename);
...
async function saveLogoFile(logoFile, destDir) {
    if (!logoFile || typeof logoFile === 'string') return null;
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].mkdir(destDir, {
        recursive: true
    });
    const ext = logoFile.name.split('.').pop();
    const filename = `logo_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$node$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}.${ext}`;
...
async function GET() {
    try {
        ...
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].get(INSTITUTIONS_CACHE_KEY);
        if (cached) {
        ...
        const institutions = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].institution.findMany({
            orderBy: {
                createdAt: 'desc'
            },
            include: {
        ...
        // Cache the result
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].set(INSTITUTIONS_CACHE_KEY, JSON.stringify(institutions), 'EX', INSTITUTIONS_CACHE_TTL);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(institutions);
    } catch (err) {
...
async function POST(req) {
    try {
        ...
        let logoUrl = null;
        if (logoFile) {
            logoUrl = await saveLogoFile(logoFile, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'institutions'));
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Save other images
        const institutionImages = await saveInstitutionFiles(formData, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'institutions'));
        // Parse locations
        let locations = [];
        if (locationsRaw) {
            try {
        ...
        const institution = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].institution.create({
            data: {
                name,
                email,
                phone,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redis"].del(INSTITUTIONS_CACHE_KEY);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(institution);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa528367._.js.map