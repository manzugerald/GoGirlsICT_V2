...
"[project]/.next-internal/server/app/api/events/upload/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
exports.Prisma.BeneficiaryRequestScalarFieldEnum = {
    id: 'id',
    title: 'title',
    beneficiaryRequestText: 'beneficiaryRequestText',
    status: 'status',
    createdAt: 'createdAt',
    updatedAt: 'updatedAt',
    beneficiaryId: 'beneficiaryId'
};
exports.Prisma.BeneficiaryMessageScalarFieldEnum = {
    id: 'id',
    title: 'title',
    beneficiaryMessageText: 'beneficiaryMessageText',
    status: 'status',
    createdAt: 'createdAt',
    updatedAt: 'updatedAt',
    beneficiaryId: 'beneficiaryId'
};
exports.Prisma.BeneficiaryRequestResponseScalarFieldEnum = {
    id: 'id',
...
;
;
async function saveUploadedFiles(formData, field, type, eventSlug// to organize per event
) {
...
"[project]/app/api/events/upload/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function toEnum(enumObject, value) {
...
async function POST(req) {
    try {
        ...
        // --- Convert enums ---
        const eventStatus = toEnum(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EventStatus"], eventStatusRaw) || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EventStatus"].pending;
        const publishStatus = toEnum(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PublishStatus"], publishStatusRaw) || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PublishStatus"].draft;
        const eventAttendance = toEnum(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AttendanceType"], eventAttendanceRaw) || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AttendanceType"].public;
        const maxAttendees = maxAttendeesRaw ? Number(maxAttendeesRaw) : null;
        // --- Slug ---
        const slug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slugify"])(eventTitle.trim());
        // --- Handle file uploads using updated helper ---
        // Banner (single file, required on create)
        let eventBanner = '';
        const bannerUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploadHelpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUploadedFile"])(formData, 'bannerFile', 'image', slug);
        if (bannerUrl) eventBanner = bannerUrl;
        // Event Images (multiple, optional)
        const eventImages = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploadHelpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUploadedFiles"])(formData, 'files', 'image', slug);
        // Event File (single, optional, pdf/doc)
        let eventFile = '';
        const eventFileUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$uploadHelpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUploadedFile"])(formData, 'eventFileUpload', 'pdf', slug);
        if (eventFileUrl) eventFile = eventFileUrl;
        // --- Create the event ---
        const createdEvent = await __TURBOPACK__imported__module__$5b$project$5d2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].event.create({
            data: {
                eventTitle,
                slug,
                eventDescription,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(createdEvent);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e8af6d8._.js.map